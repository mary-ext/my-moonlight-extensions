...
import { expandRegExp, normalizeFactory } from './modules.ts';
...
/**
 * loads non-worker lazy chunks and requires entry points found in module source.
 *
 * @returns the shared loading promise; failed calls can be retried
 */
export const loadLazyChunks = (): Promise<void> => {
